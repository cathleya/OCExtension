//
//  FESideViewController.m
//  FEFramework
//
//  Created by Tom on 15/1/22.
//  Copyright (c) 2015年 liyy. All rights reserved.
//

#import "FESideViewController.h"

#define SCREEN_WIDTH [UIScreen mainScreen].bounds.size.width
#define SCREEN_HEIGHT [UIScreen mainScreen].bounds.size.height

@interface FESideViewController ()<UIGestureRecognizerDelegate>{
...
@implementation FESideViewController
...
{
    [super viewDidLoad];
    // Do any addal setup after loading the view.
    _baseView              = self.view;
